...
- `line_wrap`: wrap long lines instead of scrolling horizontally.
- `tab_size`: number of spaces inserted by Tab (1–8).

Restart Anki or close and reopen the Cards window after changing these settings.
